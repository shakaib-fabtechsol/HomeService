...
const ReviewPublish = ({ serviceId, setValue }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`216.37.42.152/api/Deal/${deal_id}`, {
      ...
      .then((response) => {
        ...
        const updatedData = {
          ...
          image: deal?.image
            ? `216.37.42.152/uploads/${deal.image}`
            : "/default.png",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = isEdit
        ? `216.37.42.152/api/DealPublish/${dealid}` // Edit
        : `216.37.42.152/api/DealPublish/${serviceId}`; // Create
