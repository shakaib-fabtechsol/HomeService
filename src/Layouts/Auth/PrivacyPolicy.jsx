  ...
  return (
    <div className="mycontainer">
      ...
      <div className="max-w-[650px] justify-self-center">
        ...
        <h1 className="text-3xl sm:text-5xl font-semibold text-center">Privacy Policy</h1>
        ...
        <h3 className="text-lg sm:text-xl  font-semibold mt-6 sm:mt-8">Key Responsibilities:</h3>
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Providers:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Clients:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">3. PRO BUCKS PROGRAM</h2>
        <p className="text-[#535862] mt-6 sm:mt-8">
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Earning Pro Bucks:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Using Pro Bucks:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Provider Warranties:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Client Warranties:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">9. PROVIDER OBLIGATIONS</h2>
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Providers agree to:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">11. INDEMNIFICATION</h2>
        <p className="text-[#535862] mt-6 sm:mt-8">
        ...
        <p className="text-[#535862] mt-6 sm:mt-8">Home Pro Deals is not liable for:</p>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">15. PRIVACY POLICY</h2>
        <p className="text-[#535862] mt-6 sm:mt-8">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">18. TAX COMPLIANCE</h2>
        <ul class="custom-list ms-4 text-[#535862]">
          <li>
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">19. PROHIBITED CONDUCT</h2>
        <h3 className="text-lg sm:text-xl font-semibold mt-6 sm:mt-8">Users may not:</h3>
        <ul class="custom-list ms-4 text-[#535862]">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold mt-6 sm:mt-8">20. ACCOUNT SECURITY</h2>
        <p className="text-[#535862] mt-6 sm:mt-8">
